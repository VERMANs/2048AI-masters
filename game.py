...
class Game(object):
    ...
    def game(self):
        ...
        if not self.ai:
            ...
            while True:
                ...
                if len(self.board.emptyTiles()) <= 7:
                    d = self.minimax(7)
                else:
                    d = self.expectimax(2)
    ...
    def evalfn(self, b2, p=False):
        ...
        eW = 0
        if (b2.board[0][2] != 0 and b2.board[0][3] != 0 and len(high) > 128):
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Your favourite 2048, now in the terminal! Play it or have an AI solve it for you')
